...
class UITARSAgent:
    def __init__(
        ...
        self.vlm = vlm
        self.vlm = OpenAI(**self.vlm) # should replace with your UI-TARS server api
    ...
    def predict(
        ...
        while True:
            ...
            # print("\n================= Messages to VLM =================")
            # for msg in messages:
            #     if msg['role'] == 'user' and msg['content'][0]['type'] == 'image_url':
            #         print({"role": "user", "content": [{"type": "image_url", "image_url": "data:image/png;base64,..."}]})
            #         continue
